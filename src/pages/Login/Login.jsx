                ...
                <div className="bg-white p-10 py-14 rounded-xl">
                    ...
                    <form className="mt-7 border  p-5 rounded-lg" onSubmit={handleSubmit(handleLogin)}>
                        ...
                        <div className="mt-2 relative">
                            <input {...register('password', { required: true })} type={showPass ? 'text' : 'password'} name="password" placeholder="Password" required className="input input-bordered w-full focus:outline-none" />
